...
- rebuilt all functional glyph outlines from locked `lucide-static@1.25.0` sources under ISC/MIT terms;
...
- pinned the build to Node.js 24.18.0 LTS and npm 12.0.2, added registry, integrity, lifecycle-script, and dependency-vulnerability gates.
